...
export async function getStaticProps({ params }) {
  ...
  const coverImage =
    "https://geogenetics.mikedoconsulting.com/" + postsData.cover;
  return {
    props: {
      postsData,
      coverImage,
      ...
      <div>
        <Head>
          ...
          <meta
            ...
            content={this.props.postsData.summary}
          />
          <meta
            name="twitter:domain"
            content="geogenetics.mikedoconsulting.com"
          />
        ...
        <div className={Styles.container}>
          <div className={Styles.contentCard}>
            <div className={Styles.title}>{this.props.postsData.title}</div>
            <div
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: this.props.postsData.contentHtml,
              }}
            />

            <div className={Styles.tagLine}>
              {this.props.postsData.tags.map((item, index) => (
